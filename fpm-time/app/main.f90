...
'DESCRIPTION                                                                ',&
'  The fpm-time(1) fpm plugin makes using gprof(1) simple on fpm projects.  ',&
'                                                                           ',&
'  It Runs the fpm(1) command with the gfortran(1) compiler flags           ',&
'  required to build instrumented programs which will generate gprof(1)     ',&
'  output files. It then launches the specified program and runs gprof(1)   ',&
'  on the resulting profiling information.                                  ',&
'                                                                           ',&
